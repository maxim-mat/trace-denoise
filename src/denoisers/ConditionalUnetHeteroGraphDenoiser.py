...
from modules.HeteroGraphEncoder import HeteroGraphEncoder
from modules.CrossAttention import CrossAttention


class ConditionalUnetHeteroGraphDenoiser(nn.Module):
    def __init__(self, in_ch, out_ch, max_input_dim, graph_data,
        ...
        self.num_nodes_dict = {n_type: graph_data[n_type].num_nodes for n_type in graph_data.node_types}
        ...
        self.genc1 = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                        embedding_dim, hidden_dim, num_layers=1, output_dim=64, pooling=pooling)
        self.genc2 = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                        embedding_dim, hidden_dim, num_layers=2, output_dim=128, pooling=pooling)
        self.genc3 = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                        embedding_dim, hidden_dim, num_layers=3, output_dim=256, pooling=pooling)
        self.genc4 = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                        embedding_dim, hidden_dim, num_layers=3, output_dim=256, pooling=pooling)
        self.genc5 = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                        embedding_dim, hidden_dim, num_layers=2, output_dim=128, pooling=pooling)
        self.genc6 = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                        embedding_dim, hidden_dim, num_layers=1, output_dim=64, pooling=pooling)

        self.genc1_cond = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                             embedding_dim, hidden_dim, num_layers=1, output_dim=64, pooling=pooling)
        self.genc2_cond = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                             embedding_dim, hidden_dim, num_layers=2, output_dim=128, pooling=pooling)
        self.genc3_cond = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                             embedding_dim, hidden_dim, num_layers=3, output_dim=256, pooling=pooling)
        self.genc4_cond = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                             embedding_dim, hidden_dim, num_layers=3, output_dim=256, pooling=pooling)
        self.genc5_cond = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                             embedding_dim, hidden_dim, num_layers=2, output_dim=128, pooling=pooling)
        self.genc6_cond = HeteroGraphEncoder(self.metadata, self.num_nodes_dict,
                                             embedding_dim, hidden_dim, num_layers=1, output_dim=64, pooling=pooling)
